...
const projectLoggingUi = (logUiController) => {
  ...
  `)
    ...
    configSection.append(
        ...projectDebounceInput(200)(
            logUiController.loggingContextController,
            'context'
        )
    )
    configSection.append(
        ...projectLoggingChoice(logUiController.loggingLevelController)
    )
    configSection.append(
        ...projectInstantInput(
            logUiController.lastLogMessageController,
            'lastLogMessage'
        )
    )
