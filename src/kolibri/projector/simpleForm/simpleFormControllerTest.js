...
const simpleFormControllerSuite = TestSuite(
    'projector/simpleForm/simpleFormController'
)
...
simpleFormControllerSuite.add('small', (assert) => {
    ...
    nameController.onValueChanged((val) =>
        lengthController.setValue(val.length)
    )
