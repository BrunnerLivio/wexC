...
churchSuite.add('bool distribution rule', (assert) => {
    ...
    const conjunctiveNormalForm = (a) => (b) => (c) =>
        beq(and(or(a)(b))(or(a)(c)))(or(a)(and(b)(c)))
    ...
    const disjunctiveNormalForm = (a) => (b) => (c) =>
        beq(or(and(a)(b))(and(a)(c)))(and(a)(or(b)(c)))
...
churchSuite.add('recursion', (assert) => {
    ...
    assert.is(
        rec((f) => (acc) => (n) => (n < 1 ? acc : f(acc + n)(n - 1)))(0)(10),
        55
    )
...
churchSuite.add('choice', (assert) => {
    ...
    const pay = (payment) =>
        payment(
            ...
            ([from, to]) =>
                (amount) =>
                    'pay ' + amount + ' by wire from ' + from + ' to ' + to
        )
    ...
    assert.is(
        pay(payment)(50),
        'pay 50 with credit card 0000 1111 2222 3333 / 123'
    )
