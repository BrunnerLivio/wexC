...
import { reduce$, nil, snoc } from './sequence.js'
import { toSeq } from './util/helpers.js'

const performanceSuite = TestSuite('PerformanceTest')

performanceSuite.add(
    'compare SequenceBuilder and cons: SequenceBuilder 50x faster',
    (assert) => {
...
const measure = (workLoad, name) => {
    ...
    console.log(
        ...
        ' took ',
        runningTime,
        'ms and produced following result: ',
        result
    )
    return runningTime
}
