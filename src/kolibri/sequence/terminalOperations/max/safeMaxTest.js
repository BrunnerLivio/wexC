...
testSuite.add(
    ...
    (assert) => {
        ...
        // Then
        maybeMax((_) => assert.isTrue(false))((x) => assert.is(x, 1))
    }
)
...
testSuite.add('test empty sequence: should return Nothing', (assert) => {
    ...
    // Then
    maybeMax((_) => assert.isTrue(true))((_) => assert.isTrue(false))
})
...
testSuite.add(
    ...
    (assert) => {
        ...
        // Then
        maybeMax((_) => assert.isTrue(false))((x) => assert.is(x, 'aa'))
    }
)
...
testSuite.add('test largest element at the end of the iterable', (assert) => {
    ...
    // Then
    maybeMax((_) => assert.isTrue(false))((x) => assert.is(x, 9))
})
...
testSuite.add('test multiple of equal values', (assert) => {
    ...
    // Then
    maybeMax((_) => assert.isTrue(false))((x) => assert.is(x, 7))
})
