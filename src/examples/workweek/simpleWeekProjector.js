...
const projectDayWithTotal = (dayController, weekDay) => {
    ...
    'amStartCtrl amEndCtrl pmStartCtrl pmEndCtrl'
        .split(' ')
        .forEach((inputName) => {
            dayController[inputName].setName(
                weekDay + '_' + dayController[inputName].getName()
            )
            dayController[inputName].setLabel(
                weekDay + ' ' + dayController[inputName].getLabel()
            )
