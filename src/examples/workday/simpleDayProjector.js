...
const projectDay = (dayController) => {
    const [amStartViewLabel, amStartViewSpan] = projectChangeInput(
        dayController.amStartCtrl,
        'DAY'
    )
    const [amEndViewLabel, amEndViewSpan] = projectChangeInput(
        dayController.amEndCtrl,
        'DAY'
    )
    const [pmStartViewLabel, pmStartViewSpan] = projectChangeInput(
        dayController.pmStartCtrl,
        'DAY'
    )
    const [pmEndViewLabel, pmEndViewSpan] = projectChangeInput(
