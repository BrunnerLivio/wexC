...
const stanza2 = (colorName, color, cssName) =>
    dom(`
<!--suppress CssUnresolvedCustomProperty -->
    <p>${colorName}</p>    
...
root.append(
    ...stanza2('colorPrimaryDark    ', colorPrimaryDark, 'primary-dark')
)
root.append(
    ...stanza2('colorPrimaryAccent  ', colorPrimaryAccent, 'primary-accent')
)
root.append(...stanza2('colorPrimaryBg      ', colorPrimaryBg, 'primary-bg'))
root.append(
    ...stanza2('colorPrimaryLight   ', colorPrimaryLight, 'primary-light')
)
root.append(
    ...stanza2('colorSecondaryAccent', colorSecondaryAccent, 'secondary-accent')
)
root.append(
    ...stanza2('colorSecondaryDark  ', colorSecondaryDark, 'secondary-dark')
)
root.append(
    ...stanza2('colorSecondaryBg    ', colorSecondaryBg, 'secondary-bg')
)
root.append(
    ...stanza2('colorSecondaryLight ', colorSecondaryLight, 'secondary-light')
)
root.append(
    ...stanza2('colorSuccessAccent  ', colorSuccessAccent, 'success-accent')
)
root.append(
    ...stanza2('colorSuccessDark    ', colorSuccessDark, 'success-dark')
)
root.append(
    ...stanza2('colorSuccessLight   ', colorSuccessLight, 'success-light')
)
root.append(...stanza2('colorSuccessBg      ', colorSuccessBg, 'success-bg'))
root.append(
    ...stanza2('colorWarningAccent  ', colorWarningAccent, 'warning-accent')
)
root.append(
    ...stanza2('colorWarningDark    ', colorWarningDark, 'warning-dark')
)
root.append(...stanza2('colorWarningBg      ', colorWarningBg, 'warning-bg'))
root.append(
    ...stanza2('colorWarningLight   ', colorWarningLight, 'warning-light')
)
root.append(
    ...stanza2('colorDangerAccent   ', colorDangerAccent, 'danger-accent')
)
root.append(...stanza2('colorDangerDark     ', colorDangerDark, 'danger-dark'))
root.append(...stanza2('colorDangerBg       ', colorDangerBg, 'danger-bg'))
root.append(
    ...stanza2('colorDangerLight    ', colorDangerLight, 'danger-light')
)
