...
siteProjector.sideNavigationElement.append(
    ...SimpleNavigationProjector(siteController, hash2icon, true)
)
siteProjector.topNavigationElement.append(
    ...SimpleNavigationProjector(siteController, noIcons, false)
)
