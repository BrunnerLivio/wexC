    ...
    <div class="${PAGE_CLASS} prosa">
        ...
        <section>
            ...
            <p> Kolibri makes multi-way editing and other consistent updates throughout the application
                ...
                <a href="https://github.com/WebEngineering-FHNW/Kolibri/blob/main/src/examples/person/person.js">qualifier</a>
            ...
            <p> The Kolibri approach is always the same, no matter which of the many master-detail views we encounter.
                ...
                work to a 
                <a href="https://github.com/WebEngineering-FHNW/Kolibri/blob/main/src/examples/person/masterDetailProjector.js"
                >master-detail projector</a> that delegates the handling of updates to the
                <a href="https://github.com/WebEngineering-FHNW/Kolibri/blob/main/src/examples/person/instantUpdateProjector.js">instant-update
                    projector</a>.
            </p>
            ...
            <p> Test automation comes to the rescue, and it is quite easy to implement. Have a look at
                <a href="https://github.com/WebEngineering-FHNW/Kolibri/blob/main/src/examples/person/personTest.js"
